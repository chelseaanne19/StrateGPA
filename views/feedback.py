...
feedback_category = ui.select("Select submission category:", options = ["Technical Bug / Crash", "Optimisation Advice / Feature Suggestion", " General Project Input / Other"], key = "feedback_selector")
